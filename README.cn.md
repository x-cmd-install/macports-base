...
[![x-cmd/install — macports-base Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/macports-base.svg?lang=zh)](https://x-cmd.com/install/macports-base)
...
合计: **1,179,838** 行代码（覆盖前 5 种语言、共 **2579** 个文件）。
...
- **上游仓库**: <https://github.com/macports/macports-base>
- **官网**: <https://trac.macports.org>
- **许可证**: BSD-3-Clause
...
- **Star**: 1,045 · **Fork**: 291 · **开放 issue**: 0 · **贡献者**: 89

## 累计统计

- **发布数**: 69 · **已合并 PR**: 266 · **开放 PR**: 34 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 9072

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-27 | 0 | 0 | 0 | 0 | 0 | 8 |
| last60d | 2026-07-28 | 1 | 0 | 2 | 0 | 0 | 20 |
| 90d | 2026-06-28 | 1 | 2 | 2 | 0 | 0 | 33 |
| last180d | 2026-03-30 | 2 | 11 | 5 | 0 | 0 | 129 |
| 360d | 2025-10-01 | 11 | 27 | 8 | 0 | 0 | 288 |
| last720d | 2024-10-06 | 24 | 39 | 8 | 0 | 0 | 516 |
...
macports-base 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `macports-base` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/macports-base.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T04:55:35Z._
