...
[![x-cmd/install — macports-base Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/macports-base.svg)](https://x-cmd.com/install/macports-base)
...
- **Edit the package entry**: <https://github.com/x-cmd/install/edit/main/macports-base.yml> (or whichever path the index uses)

The data on this page (card / loc / scorecard / release) is auto-collected by [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) and is regenerated daily. Improvements to *install behaviour* (which version gets installed, platform-specific quirks, dependencies) belong upstream in the index.

_Snapshot: `data/card/260926.yml` · 2026-09-26T04:55:33Z._
